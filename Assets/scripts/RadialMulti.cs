...
public class RadialMulti : MonoBehaviour {
	...
	void Start () {
		...
		kaleidoscope1 = new RadialKaleidoscope (1.0f, 10, 1.0f, 0.25f, camHeading, mCamera);
		kaleidoscope2 = new RadialKaleidoscope (2.0f, 10, 0.25f, 0.125f, camHeading, mCamera);
	...
	private class RadialKaleidoscope {
		...
		//constructor
		public RadialKaleidoscope(float off, int cuCt, float r, float rot, Vector3 cHd, WebCamTexture mCam ){
